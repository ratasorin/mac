...
free_terms = [6 -2 -7];
[A, x] = gauss_solve_sistem(coefficient_matrix, free_terms); % the result should be: x = [-1.539682 0.5238095 1.11111111]
...
sol = gauss_seidel_solve_sistem(coefficient_matrix_gs, free_terms_gs, 10)